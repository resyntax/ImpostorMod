...
namespace ImpostorMod.SkillStates
{
    public class Roll : BaseSkillState
    {
        ...
        public override void OnEnter()
        {
            ...
            {
                base.characterBody.AddTimedBuff(Modules.Buffs.armorBuff, 2f * Roll.duration);
                base.characterBody.AddTimedBuff(RoR2Content.Buffs.HiddenInvincibility, 0.33f * Roll.duration);
            }
        }
